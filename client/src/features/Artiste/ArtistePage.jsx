  ...
  return (
    <section className=" text-gray-200">
      <Helmet prioritizeSeoTags>
        <title>{`${data.artiste.name} songs Mp3. New Songs and Albums - Stream on RhythMix`}</title>
        <link
          rel="canonical"
          href={`https://RhythMix.vercel.app/artistes/${data.artiste._id}`}
        />
        <meta
          name="description"
          content={`Stream ${data.artiste.name}'s latest songs and albums on RhythMix and enjoy other amazing music collections.`}
        />
        <meta
          property="og:title"
          content={`${data.artiste.name} songs Mp3. New Songs and Albums - Stream on RhythMix`}
        />
        <meta
        ...
        <meta
          property="og:url"
          content={`https://RhythMix-server.vercel.app/artistes/${data.artiste._id}`}
        />
