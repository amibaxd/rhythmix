  ...
  return (
    <section className="text-gray-100">
      <Helmet prioritizeSeoTags>
        <title>{`Artistes - RhythMix`}</title>
        <link rel="canonical" href={`https://RhythMix.vercel.app/artistes`} />
        <meta
          name="description"
          content={`Connect with your favorite artistes and stay up-to-date with their latest releases`}
        />
        <meta property="og:title" content="Artistes - RhythMix" />
        <meta
          property="og:url"
          content={`https://RhythMix-server.vercel.app/artistes`}
        />
        <meta
          property="og:description"
          content={`Connect with your favorite artistes and stay up-to-date with their latest releases`}
        />
        <meta name="twitter:title" content="Artistes - RhythMix" />
        <meta
