  ...
  return (
    <section className=" text-gray-200">
      <Helmet prioritizeSeoTags>
        <title>{`${playlist.title} - Stream on RhythMix`}</title>
        <link
          rel="canonical"
          href={`https://RhythMix.vercel.app/playlists/${playlist._id}`}
        />
        <meta
          name="description"
          content={`Stream ${playlist.title} on RhythMix and enjoy other amazing music collections.`}
        />
        <meta
          property="og:title"
          content={`${playlist.title} - Stream on RhythMix`}
        />
        <meta
        ...
        <meta
          property="og:url"
          content={`https://RhythMix-server.vercel.app/playlists/${playlist._id}`}
        />
