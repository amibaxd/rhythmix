  ...
  return (
    <section className="text-gray-100">
      <Helmet prioritizeSeoTags>
        <title>{`Playlists - RhythMix`}</title>
        <link rel="canonical" href={`https://RhythMix.vercel.app/playlists`} />
        <meta
          name="description"
          content={`Unleash your musical journey from our collection of playlists`}
        />
        <meta property="og:title" content="Playlists - RhythMix" />
        <meta
          property="og:url"
          content={`https://RhythMix-server.vercel.app/playlists`}
        />
        <meta
          property="og:description"
          content={`Unleash your musical journey from our collection of playlists`}
        />
        <meta name="twitter:title" content="Playlists - RhythMix" />
        <meta
