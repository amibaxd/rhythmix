...
const key = import.meta.env.VITE_BEATIFY_KEY;
...
const Player = () => {
  ...
  return (
    <>
      <article
        className={`relative p-4 bg-secondary-100/80 backdrop-blur-lg text-white border-t border-neon/20 neon-glow`}
      >
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            {currentSong?.coverImage ? (
              ...
              <div className="bg-secondary-200/50 mr-4 w-14 h-14 rounded-lg neon-border">
                <FaCompactDisc className="w-full h-full p-2 text-neon animate-spin" />
              </div>
            )}
            <div className="w-20">
              <Link
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <button
              ...
              className={`p-4 rounded-full bg-${selectedTheme} neon-glow hover:scale-110 transition-all duration-300`}
            >
              {isLoading ? (
