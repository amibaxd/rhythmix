  ...
  return (
    <section className=" text-gray-100">
      <Helmet prioritizeSeoTags>
        <title>{`Users - RhythMix`}</title>
        <link
          rel="canonical"
          href={`https://RhythMix.vercel.app/users/${user._id}`}
        />
        <meta
          name="description"
          content={`Connect with music lovers on RhythMix`}
        />
        <meta property="og:title" content="Users - RhythMix" />
        <meta
          property="og:url"
          content={`https://RhythMix-server.vercel.app/users/${user._id}`}
        />
        <meta
          property="og:description"
          content={`Connect with music lovers on RhythMix`}
        />
        <meta name="twitter:title" content="Users - RhythMix" />
        <meta
