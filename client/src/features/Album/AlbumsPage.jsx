  ...
  return (
    <section className="text-gray-100">
      <Helmet prioritizeSeoTags>
        <title>{`Albums - RhythMix`}</title>
        <link rel="canonical" href={`https://RhythMix.vercel.app/albums`} />
        <meta
          name="description"
          content={`Indulge your passion for music with our handpicked selection of albums`}
        />
        <meta property="og:title" content="Albums - RhythMix" />
        <meta
          property="og:url"
          content={`https://RhythMix-server.vercel.app/albums`}
        />
        <meta
          property="og:description"
          content={`Indulge your passion for music with our handpicked selection of albums`}
        />
        <meta name="twitter:title" content="Albums - RhythMix" />
        <meta
